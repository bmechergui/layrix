...
Utile pour tes templates Layrix (ex: skill « Extraction Factures », skill « Deep Research », skill « Support Client en arabe »).
...
Essentiel pour que les utilisateurs de Layrix puissent lancer un agent, partir, et revenir plus tard.
