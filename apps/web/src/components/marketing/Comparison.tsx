...
import { COMPARISON_FEATURES, COMPARISON_TOOLS } from '@/lib/marketing-content';
            ...
            <thead>
              <tr className="border-b border-border">
                ...
                {COMPARISON_TOOLS.map((t) => (
                  <th key={t.name} className={`text-center py-4 px-4 text-sm font-semibold min-w-[90px] ${t.name === 'Layrix' ? 'text-primary' : 'text-foreground'}`}>
                    {t.name}
                  </th>
                ))}
              </tr>
